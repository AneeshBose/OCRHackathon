...
target_offsets = {'Healthcare Organization Name': [-2, -21, 565, -19, 565, 16, -2, 15], 'Provider Name': [-2, -29, 564, -30, 564, 12, -2, 12], 'NPI #': [-2, -25, 565, -23, 565, 16, -2, 15], 'Other(s)': [-2, -11, 553, -12, 553, 18, -2, 20], 'Location Address': [-3, -34, 563, -34, 563, 19, -3, 19], 'City, State, Zip1': [-2, -24, 563, -25, 563, 19, -2, 20], 'Phone Number': [-2, -19, 564, -19, 564, 12, -2, 12], 'Secure Fax Number': [-2, -19, 563, -17, 563, 6, -2, 4], 'Patient ID/MRN': [-2, -16, 565, -16, 565, 13, -2, 13], 'Phone Number (required)': [-2, -18, 560, -19, 560, -3, -2, -2], 'First Name': [-2, -21, 236, -22, 236, 17, -2, 18], 'Last Name': [-2, -20, 322, -20, 322, 18, -2, 18], 'Language Preference (optional)': [-2, -19, 555, -18, 555, 14, -2, 13], 'DOB (mm/dd/yyyy)': [-2, -17, 319, -18, 319, 0, -2, 0], 'Shipping Address': [-2, -24, 564, -24, 564, 51, -2, 51], 'Billing Address': [-2, -19, 554, -20, 554, 55, -2, 56], 'City, State, Zip2': [-2, -20, 566, -21, 566, 2, -2, 2], 'City, State, Zip3': [-2, -18, 555, -17, 555, 36, -2, 35], 'Policyholder Name': [-2, -20, 363, -20, 363, 15, -2, 16], 'Policyholder DOB': [-2, -18, 279, -16, 279, 19, -2, 18], 'Primary Insurance Carrier': [-2, -19, 469, -19, 469, 17, -2, 16], 'Claims Submission Address': [-2, -17, 1135, -17, 1135, 15, -2, 14], 'Subscriber ID/Policy Number': [-2, -19, 437, -19, 437, 13, -2, 12], 'Group Number': [-2, -20, 346, -20, 346, 13, -2, 13], 'Plan': [-2, -22, 346, -24, 346, 23, -2, 25], 'Prior-Authorization Code (if available)': [-2, -15, 1136, -15, 1136, 6, -2, 6], 'Date': [-2, -12, 385, -14, 385, 6, -2, 7]}
	...
	for target_field in target_bounding_boxes:
		...
		if polygon_ptext.contains(polygon_htext) == True:
			if target_field not in field_mappings:
				field_mappings[target_field] = line['text']
			else:
				field_mappings[target_field] += line['text']
			print("Target Field",target_field)
			print("Handwritten text",line['text'])
